...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ac-html-bootstrap ac-html-csswatcher avy browse-kill-ring
                       color-theme-sanityinc-solarized
                       color-theme-sanityinc-tomorrow company
                       company-statistics company-web consult corfu
                       corfu-terminal counsel default-text-scale
                       diff-hl diminish dimmer diredfl disable-mouse
 ...
 '(spacemacs-theme-custom-colors
   '((act1 . "##D48B1C") (act2 . "#0000ff") (base . "#ffffff"))))
(custom-set-faces
